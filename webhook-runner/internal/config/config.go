...
func ConnectDB() {
	if err := godotenv.Load(); err != nil {
		log.Println("Warning: Error loading .env file in webhook-runner service")
	}
	...
	log.Fatalf("Failed to connect to webhook-runner database after %d attempts: %v", maxRetries, err)
}
