...
CREATE DATABASE IF NOT EXISTS `webhook_request_tracker` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON `webhook_request_tracker`.* TO 'root'@'%';
