...
import (
	...
	"requestTrackerService/internal/middleware"
...
func (a *App) Run(ctx context.Context) error {
	...
	go func() {
		log.Printf("Request Tracker gRPC server listening on %s (Protected)\n", address)
	...
	log.Println("Request Tracker gRPC server and Kafka worker stopped cleanly.")
	return nil
}
