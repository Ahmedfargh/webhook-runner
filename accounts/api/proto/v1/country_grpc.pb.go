...
const (
	CountryService_ListCountries_FullMethodName = "/accounts.v1.CountryService/ListCountries"
	CountryService_GetCountry_FullMethodName    = "/accounts.v1.CountryService/GetCountry"
)
...
func (c *countryServiceClient) GetCountry(ctx context.Context, in *GetCountryRequest, opts ...grpc.CallOption) (*CountryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCountryServiceServer) GetCountry(context.Context, *GetCountryRequest) (*CountryResponse, error) {
...
var CountryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "accounts.v1.CountryService",
