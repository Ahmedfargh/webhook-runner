...
const (
	RoleService_CreateRole_FullMethodName              = "/accounts.v1.RoleService/CreateRole"
	RoleService_GetRole_FullMethodName                 = "/accounts.v1.RoleService/GetRole"
	RoleService_UpdateRole_FullMethodName              = "/accounts.v1.RoleService/UpdateRole"
	RoleService_DeleteRole_FullMethodName              = "/accounts.v1.RoleService/DeleteRole"
	RoleService_ListRoles_FullMethodName               = "/accounts.v1.RoleService/ListRoles"
	RoleService_AssignPermissionsToRole_FullMethodName = "/accounts.v1.RoleService/AssignPermissionsToRole"
)
...
type RoleServiceClient interface {
	...
	AssignPermissionsToRole(ctx context.Context, in *AssignPermissionsToRoleRequest, opts ...grpc.CallOption) (*RoleResponse, error)
}
...
func (c *roleServiceClient) AssignPermissionsToRole(ctx context.Context, in *AssignPermissionsToRoleRequest, opts ...grpc.CallOption) (*RoleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleResponse)
	err := c.cc.Invoke(ctx, RoleService_AssignPermissionsToRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoleServiceServer interface {
	...
	AssignPermissionsToRole(context.Context, *AssignPermissionsToRoleRequest) (*RoleResponse, error)
...
func (UnimplementedRoleServiceServer) AssignPermissionsToRole(context.Context, *AssignPermissionsToRoleRequest) (*RoleResponse, error) {
...
func _RoleService_AssignPermissionsToRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssignPermissionsToRoleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoleServiceServer).AssignPermissionsToRole(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoleService_AssignPermissionsToRole_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).AssignPermissionsToRole(ctx, req.(*AssignPermissionsToRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "accounts.v1.RoleService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RoleService_AssignPermissionsToRole_Handler,
		},
	},
