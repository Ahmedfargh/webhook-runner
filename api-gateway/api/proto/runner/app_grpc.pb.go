...
const (
	AppService_CreateApp_FullMethodName     = "/webhook_runner.v1.AppService/CreateApp"
	AppService_GetApp_FullMethodName        = "/webhook_runner.v1.AppService/GetApp"
	AppService_ListApps_FullMethodName      = "/webhook_runner.v1.AppService/ListApps"
	AppService_UpdateApp_FullMethodName     = "/webhook_runner.v1.AppService/UpdateApp"
	AppService_DeleteApp_FullMethodName     = "/webhook_runner.v1.AppService/DeleteApp"
	AppService_RotateSecrets_FullMethodName = "/webhook_runner.v1.AppService/RotateSecrets"
)
...
type AppServiceClient interface {
	...
	RotateSecrets(ctx context.Context, in *RotateSecretsRequest, opts ...grpc.CallOption) (*RotateSecretsResponse, error)
}
...
func (c *appServiceClient) RotateSecrets(ctx context.Context, in *RotateSecretsRequest, opts ...grpc.CallOption) (*RotateSecretsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RotateSecretsResponse)
	err := c.cc.Invoke(ctx, AppService_RotateSecrets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppServiceServer interface {
	...
	RotateSecrets(context.Context, *RotateSecretsRequest) (*RotateSecretsResponse, error)
...
func (UnimplementedAppServiceServer) RotateSecrets(context.Context, *RotateSecretsRequest) (*RotateSecretsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RotateSecrets not implemented")
}
...
func _AppService_RotateSecrets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RotateSecretsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppServiceServer).RotateSecrets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AppService_RotateSecrets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServiceServer).RotateSecrets(ctx, req.(*RotateSecretsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "webhook_runner.v1.AppService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RotateSecrets",
			Handler:    _AppService_RotateSecrets_Handler,
		},
	},
