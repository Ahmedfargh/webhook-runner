...
const (
	AdminService_CreateAdmin_FullMethodName              = "/accounts.v1.AdminService/CreateAdmin"
	AdminService_GetAdmin_FullMethodName                 = "/accounts.v1.AdminService/GetAdmin"
	AdminService_UpdateAdmin_FullMethodName              = "/accounts.v1.AdminService/UpdateAdmin"
	AdminService_DeleteAdmin_FullMethodName              = "/accounts.v1.AdminService/DeleteAdmin"
	AdminService_ListAdmins_FullMethodName               = "/accounts.v1.AdminService/ListAdmins"
	AdminService_AssignRolesToAdmin_FullMethodName       = "/accounts.v1.AdminService/AssignRolesToAdmin"
	AdminService_AssignPermissionsToAdmin_FullMethodName = "/accounts.v1.AdminService/AssignPermissionsToAdmin"
)
...
type AdminServiceClient interface {
	...
	AssignRolesToAdmin(ctx context.Context, in *AssignRolesToAdminRequest, opts ...grpc.CallOption) (*AdminResponse, error)
	AssignPermissionsToAdmin(ctx context.Context, in *AssignPermissionsToAdminRequest, opts ...grpc.CallOption) (*AdminResponse, error)
}
...
func (c *adminServiceClient) AssignRolesToAdmin(ctx context.Context, in *AssignRolesToAdminRequest, opts ...grpc.CallOption) (*AdminResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminResponse)
	err := c.cc.Invoke(ctx, AdminService_AssignRolesToAdmin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) AssignPermissionsToAdmin(ctx context.Context, in *AssignPermissionsToAdminRequest, opts ...grpc.CallOption) (*AdminResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminResponse)
	err := c.cc.Invoke(ctx, AdminService_AssignPermissionsToAdmin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServiceServer interface {
	...
	AssignRolesToAdmin(context.Context, *AssignRolesToAdminRequest) (*AdminResponse, error)
	AssignPermissionsToAdmin(context.Context, *AssignPermissionsToAdminRequest) (*AdminResponse, error)
...
func (UnimplementedAdminServiceServer) AssignRolesToAdmin(context.Context, *AssignRolesToAdminRequest) (*AdminResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AssignRolesToAdmin not implemented")
}
func (UnimplementedAdminServiceServer) AssignPermissionsToAdmin(context.Context, *AssignPermissionsToAdminRequest) (*AdminResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AssignPermissionsToAdmin not implemented")
}
...
func _AdminService_AssignRolesToAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssignRolesToAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).AssignRolesToAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_AssignRolesToAdmin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).AssignRolesToAdmin(ctx, req.(*AssignRolesToAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AdminService_AssignPermissionsToAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssignPermissionsToAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).AssignPermissionsToAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_AssignPermissionsToAdmin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).AssignPermissionsToAdmin(ctx, req.(*AssignPermissionsToAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "accounts.v1.AdminService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AssignRolesToAdmin",
			Handler:    _AdminService_AssignRolesToAdmin_Handler,
		},
		{
			MethodName: "AssignPermissionsToAdmin",
			Handler:    _AdminService_AssignPermissionsToAdmin_Handler,
		},
	},
